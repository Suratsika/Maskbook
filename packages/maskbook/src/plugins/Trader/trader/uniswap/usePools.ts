...
export function usePools(
    ...
    const [slot0s, slot0sCalls, slot0sState, slot0sCallback] = useMutlipleContractSingleData(poolContracts, new Array(poolContracts.length).fill('slot0'), [])
    const [liquidities, liquiditiesCalls, liquiditiesState, liquiditiesCallback] = useMutlipleContractSingleData(poolContracts, new Array(poolContracts.length).fill('liquidity'), [])
